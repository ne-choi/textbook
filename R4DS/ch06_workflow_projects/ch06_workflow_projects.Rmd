...
1. 분석한 내용의 실체는 무엇인가(저장해야 할 내용이 무엇인가)  
...
Rstudio를 종료하고 r4ds.Rproj 파일을 실행시켜 프로젝트를 다시 열었을 때,  
동일한 디렉터리와 명령어 이력 그리고 작업중이었던 모든 파일이 여전히 열려있는지 확인해보자.
