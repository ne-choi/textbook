...
### 2.1 연습문제
1. RStudio Tips 트위터 계정인 [@rstudiotips](https://twitter.com/rstudiotips)에서 다양한 팁을 찾아볼 수 있다.  

2. RStudio 진단으로 알 수 있는 일반적인 실수들을 찾아보자.
[RStudiocodediag](http://bit.ly/RStudiocodediag)