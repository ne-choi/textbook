...
3. Alt + Shift + K를 누르고 어떻게 되는지 보라. 어떤 메뉴를 눌러야 같은 동작을 할 수 있는가?  
답: 키보드 단축키 정리 항목을 볼 수 있음, Tools -> Keyboard Shortcuts Help 선택  
