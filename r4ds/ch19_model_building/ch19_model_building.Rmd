...
앞장과 똑같은 도구를 사용하지만 실제 데이터셋 (ggplot2 패키지의 diamonds,  
...
하지만 데이터가 1년치밖에 없어서 이유를 알기는 힘들다  
...
미국인에게 가을은 추수감사절과 크리스마스가 있어 휴가를 계획하는 것은 일반적이지 않은듯하다  
